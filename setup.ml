...
(* OASIS_START *)
(* DO NOT EDIT (digest: 6b888e2554c9f8c4c48bedf2e45834a5) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/mwweissmann/ocaml-posix-math/";
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_cclib = [(OASISExpr.EBool true, ["-lm"])];
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "API reference for POSIX math";
                      doc_authors = [];
                      doc_abstract = None;
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "test/";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "posix-math"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "B\012Häýã )\023\\\022£\031h0ú";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
